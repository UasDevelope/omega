...
class AppAssets {
  ...
  static get suppliments => "suppliments".svg;
  static get add => "add".svg;
  static get time => "time".svg;
  static get account => "account".svg;
  static get close => "close".svg;
  static get support => "support".svg;
  static get progress => "progress".svg;
  static get simpleNotification => "simpleNotification".svg;
  static get invite => "invite".svg;
}
